...
<head>
    ...
    <meta name="description"
          content="Sipway admin is super flexible, powerful, clean &amp; modern responsive bootstrap 5 admin template with unlimited possibilities.">
    <meta name="keywords"
          content="admin template, Sipway admin template, dashboard template, flat admin template, responsive admin template, web app">
                                ...
                                <div>
                                    <div class="table-responsive table-desi">
                                        <table class="user-table table table-striped">
                                            ...
                                            $admin_rs2 = MySQL::search("SELECT * FROM admin LIMIT ${results_per_page} OFFSET ${viewed_count}");
                                                    ...
                                                    <td>
                                                        <div class="form-check form-switch p-3 d-flex justify-content-center">
                                                            <input id="admin_status_switch<?= $x ?>"
                                                                   ...
                                                                   role="switch"
                                                                   onchange="change_admin_status('<?= $admin["email"] ?>', 'admin_status_switch<?= $x ?>')" <?= ($admin["status"] == 1) ? "checked" : "" ?>>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    <span>
                                                    <img src="../<?= ($admin['profile_img'] != null) ? $admin['profile_img'] : 'assets/images/users/5.jpg' ?>"
                                                         alt="users">
                                                    </span>
                                                    </td>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                ...
                                                                <button class="table-button text-primary"
                                                                        onclick='show_admin_update_modal(<?= json_encode($admin) ?>)'>
                                                                    <span class="lnr lnr-pencil"></span>
                                                                </button>
                                                            </li>

                                                            <li>
                                                                <button onclick="show_admin_delete_confirm_modal('<?= $admin["email"] ?>')"
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="button-box">
                    ...
                    <button type="button" class="btn btn--yes btn-primary" onclick="update_admin()">Update</button>
                </div>
            </div>
        </div>
    </div>
