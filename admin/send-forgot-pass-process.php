...
if (isset($email)) {
    ...
    if ($adminRs->num_rows > 0) {
        ...
        if ($adminData['is_verified'] == 1) {
            $verification_code = uniqid("admin_rp_");
            MySQL::iud("UPDATE admin SET verification_code='${verification_code}' WHERE email='${email}'");
