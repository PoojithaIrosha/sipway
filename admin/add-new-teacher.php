...
<head>
    ...
    <title>Sipway - Add New User</title>
                                            ...
                                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel">
                                                <div class="theme-form theme-form-2 mega-form">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="mb-4 row align-items-center">
                                                            <label class="form-label-title col-lg-2 col-md-3 mb-0">Last
                                                                Name</label>
                                                            <div class="col-md-9 col-lg-10">
                                                        ...
                                                        <div class="mb-4 row align-items-center">
                                                            <label class="col-lg-2 col-md-3 col-form-label form-label-title">Mobile
                                                                Number</label>
                                                            <div class="col-md-9 col-lg-10">
                                                        ...
                                                        <div class="mb-4 row align-items-center">
                                                            <label for="" class="form-label-title">Subjects</label>
                                                            <div class="table-responsive table-desi">
                                                                <table class="user-table table table-striped">
                                                                    ...
                                                                    <?php
                                                                    $x = 1;
                                                                    $subjectRs = MySQL::search("SELECT *, subject.id as id FROM subject JOIN year y on y.id = subject.year_id");

                                                                    $subList = array();
                                                                    while ($thsData = $subjectRs->fetch_assoc()) {
                                                                        ?>
                                                                        <tr>
                                                                            <td class="mt-2"><input
                                                        ...
                                                        <div class="mb-4">
                                                            <button type="submit" class="btn btn-primary"
                                                                    id="register-btn"
                                                                    onclick='registerTeacher(<?= json_encode($subList) ?>)'>
                                                                Register New
                                                                Teacher
                                                            </button>
