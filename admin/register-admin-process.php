...
if (empty($fname)) {
    ...
    $admin_rs = MySQL::search("SELECT * FROM admin WHERE email = '${email}' OR mobile = '${mobile}'");
    if ($admin_rs->num_rows > 0) {
        ...
        // Register new admin
        MySQL::iud("INSERT INTO admin(email, first_name, last_name, mobile, password, verification_code, creation_time) VALUE ('${email}','${fname}', '${lname}', '${mobile}', '${password}', '${verification_code}', '${creation_date}')");

        // Send email verification to the newly created admin
        ...
        try {
            ...
            $mail->Subject = 'Verify Admin Account - SipWay';
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="image_block block-2"
                                        ...
                                        <tr>
											<div style="display: flex; justify-content: center;">
												<span style="font-size:30px;color:#2b303a;font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; "><strong>SipWay - Admin Account</strong></span>
											</div>
                                        </tr>
                                    </table>
                                            ...
                                            <td class="pad"
                                                ...
                                                <div align="center" class="alignment">
                                                    ...
                                                    <div style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#ff0070;border-radius:60px;width:auto;border-top:0px solid transparent;font-weight:400;border-right:0px solid transparent;border-bottom:0px solid transparent;border-left:0px solid transparent;padding-top:15px;padding-bottom:15px;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:16px;text-align:center;mso-border-alt:none;word-break:keep-all;">
                                                        ...
                                                        <a href="http://localhost/sipway/admin/verify-admin.php?admin_code=' . $verification_code . '" style="margin: 0; word-break: break-word; line-height: 32px; color: white; text-decoration: none;"><strong>Verify Your Email</strong></a>
                                                        </span>
                                                    </div>
													<div style="margin-top: 25px">
														<span style="font-size:15px;font-family: Tahoma; color:gray;">Please click the button verify email to verify your newly created admin account</span>
													</div>
