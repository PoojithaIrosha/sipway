...
$cemail = $_POST['cemail'];
$mobile = $_POST['mobile'];
$subList = json_decode($_POST['subList']);
...
if (empty($fname)) {
    ...
    $teacher_rs = MySQL::search("SELECT * FROM teacher WHERE email = '${email}' OR mobile = '${mobile}'");
    if ($teacher_rs->num_rows > 0) {
        ...
        MySQL::iud("INSERT INTO teacher(email, first_name, last_name, mobile, password, verification_code, creation_time) VALUE ('${email}','${fname}', '${lname}', '${mobile}', '${password}', '${verification_code}', '${creation_date}')");

        // Assign Subjects

        foreach ($subList as $subId) {
            MySQL::iud("INSERT INTO teacher_has_subject(teacher_email, subject_id) VALUE ('${email}', '${subId}')");
        }
        ...
        try {
            ...
            $mail->Subject = 'Verify Teacher Account - SipWay';
                                            ...
                                            <td class="pad"
                                                ...
                                                <div align="center" class="alignment">
                                                    ...
                                                    <div style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#ff0070;border-radius:60px;width:auto;border-top:0px solid transparent;font-weight:400;border-right:0px solid transparent;border-bottom:0px solid transparent;border-left:0px solid transparent;padding-top:15px;padding-bottom:15px;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:16px;text-align:center;mso-border-alt:none;word-break:keep-all;">
                                                        ...
                                                        <a href="http://localhost/sipway/teacher/verify-teacher.php?teacher_code=' . $verification_code . '" style="margin: 0; word-break: break-word; line-height: 32px; color: white; text-decoration: none;"><strong>Verify Your Email</strong></a>
                                                        </span>
                                                    </div>
													<div style="margin-top: 25px">
														<span style="font-size:15px;font-family: Tahoma; color:gray;">Please click the button verify email to verify your newly created teacher account</span>
													</div>
