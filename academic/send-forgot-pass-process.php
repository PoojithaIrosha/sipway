...
if (isset($email)) {
    ...
    if ($academicRs->num_rows > 0) {
        ...
        if ($academicData['is_verified'] == 1) {
            $verification_code = uniqid("academic_rp_");
            MySQL::iud("UPDATE academic_officer SET verification_code='${verification_code}' WHERE email='${email}'");

            // Send email verification to the newly created academic officer
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="image_block block-2"
                                        ...
                                        <tr>
											<div style="display: flex; justify-content: center;">
												<span style="font-size:30px;color:#2b303a;font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; "><strong>SipWay - Academic Officer Account</strong></span>
											</div>
                                        </tr>
                                    </table>
