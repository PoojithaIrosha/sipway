...
if (isset($email)) {
    ...
    if ($studentRs->num_rows > 0) {
        ...
        if ($studentData['is_verified'] == 1) {
            $verification_code = uniqid("student_rp_");
            MySQL::iud("UPDATE student SET verification_code='${verification_code}' WHERE email='${email}'");
